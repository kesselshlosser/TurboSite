...
<head>
	...
	<meta property="og:description" content="{($meta_description|default:$auto_meta->description)|escape}{$filter_meta->description|escape}">
	...
	<meta name="twitter:description" content="{($meta_description|default:$auto_meta->description)|escape}{$filter_meta->description|escape}">
	<meta name="twitter:image" content="{$config->root_url}/design/{$settings->theme|escape}/images/logo.png">
	{/if}
...
<body itemscope itemtype="https://schema.org/WebPage">
	...
	<nav itemscope itemtype="https://schema.org/SiteNavigationElement" class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
		<div class="container">
			<a class="navbar-brand" href="{$lang_link}">Turbo Site</a>
			...
			<div class="collapse navbar-collapse" id="navbarsExample09">
				...
				<ul class="nav navbar-nav navbar-right">
					...
					{/if}
					{if $user}
					<li class="nav-link"><i class="fa fa-user"></i> <a class="text-white-50 card-link" href="{$lang_link}user">{$user->name}</a></li>
					<li class="nav-link"><i class="fa fa-sign-in-alt"></i> <a class="text-white-50 card-link" href="{$lang_link}user/logout">{$lang->logout}</a></li>
					{else}
					<li class="nav-link"><i class="fa fa-sign-in-alt"></i> <a class="text-white-50 card-link" href="{$lang_link}user/login"> {$lang->login}</a></li>
					<li class="nav-link"><i class="fa fa-user-plus"></i> <a class="text-white-50 card-link" href="{$lang_link}user/register">{$lang->registration}</a></li>
					{/if}
				</ul>
			</div>
		</div> 
	...
	<div class="bg-light">
		<div class="container">
			<div class="row text-center pad-top pad-bottom">
				<div class="col-md-4">
					<i class="fa fa-comments fa-3x icon-custom text-primary"></i>
				...
				<div class="col-md-4">
					<i class="fa fa-desktop fa-3x icon-custom text-primary"></i>
				...
				<div class="col-md-4">
					<i class="fa fa-recycle fa-3x icon-custom text-primary"></i>
	...
	<div class="container mt-5">
		...
		<div class="row my-4">
			<div class="col-md-8">
				<p>{$lang->callback_message}</p>
			</div>
			<div class="col-md-4">
				<a class="btn btn-lg btn-success btn-block" href="javascript:void(0)" data-toggle="modal" data-target="#exampleModal" role="button"><i class="fa fa-phone"></i> {$lang->callback}</a>
			</div>
		</div>
	</div>
	{/if}
