        ...
        <div class="wrap_heading">
            ...
            {if !$locked_theme}
                <div class="box_btn_heading">
                    <a class="btn btn_small btn-info" href="{url module=TranslationAdmin return=$smarty.server.REQUEST_URI}">
...
<div class="boxed fn_toggle_wrap">
    ...
    <form class="fn_form_list" method="post">
        ...
        <div class="translation_wrap turbo_list projects_list fn_sort_list">
                    ...
                    <div class="fn_row turbo_list_body_item fn_sort_item"{if !$translations_template[$label]} title="{$btr->translations_system_translation}"{/if}>
                        <div class="turbo_list_row ">
                            <div class="turbo_list_boding turbo_list_check">
                                <input class="hidden_check" type="checkbox" id="{$translation->id}" name="check[]" value="{$translation->id}" />
                                <label class="turbo_ckeckbox" for="{$translation->id}"></label>
                            </div>
