    ...
    <div class="col-lg-7 col-md-12">
        <div class="wrap_heading">
			...
			<div class="box_btn_heading">
                <a class="btn btn_small btn-info" href="{url module=ProjectAdmin return=$smarty.server.REQUEST_URI}">
                        ...
                        <div class="fn_row turbo_list_body_item fn_sort_item">
                            <div class="turbo_list_row">
                                ...
                                <div class="turbo_list_boding turbo_list_check">
                                    <input class="hidden_check" type="checkbox" id="id_{$project->id}" name="check[]" value="{$project->id}"/>
                                    <label class="turbo_ckeckbox" for="id_{$project->id}"></label>
                                </div>
                                ...
                                <div class="turbo_list_boding turbo_list_status">
                                    <label class="switch switch-default ">
                                        <input class="switch-input fn_ajax_action {if $project->visible}fn_active_class{/if}" data-module="projects" data-action="visible" data-id="{$project->id}" name="visible" value="1" type="checkbox"  {if $project->visible}checked=""{/if}/>
