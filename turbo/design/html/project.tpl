    ...
    <div class="col-lg-12 col-md-12">
        <div class="wrap_heading">
            ...
            <div class="box_btn_heading">
                <a class="btn btn_small btn-info add" target="_blank" href="../{$lang_link}project/{$project->url}" >
                            ...
                            <div class="activity_of_switch_item">
                                <div class="turbo_switch clearfix">
                                    ...
                                    <label class="switch switch-default">
                                        <input class="switch-input" name="visible" value='1' type="checkbox" id="visible_checkbox" {if $project->visible}checked=""{/if}/>
                ...
                <div class="toggle_body_wrap fn_card on ">
                    <ul class="fn_droplist_wrap project_images_list clearfix sortable" data-image="project">
                        ...
                        <li class="project_image_item {if $image@first}first_image{/if} {if $image@iteration > 4}fn_toggle_hidden hidden{/if} fn_sort_item">
                            ...
                            <i class="move_zone">
                                {if $image}
                                    <img class="project_icon" src="{$image->filename|resize:300:120}" alt=""/>
                                {else}
                            ...
                            <div class="fn_row turbo turbo_list_body_item fn_sort_item">
                                <div class="turbo_list_row">
                                    ...
                                    <div class="turbo_list_boding turbo_list_close">
                                        <button data-hint="Удалить проект" type="button" class="btn_close fn_remove_item hint-bottom-right-t-info-s-small-mobile  hint-anim">
