...
<script>
    $(function(){
        tinyMCE.init({literal}{{/literal}
            ...
            toolbar: 'undo redo | formatselect | bold italic underline | alignleft aligncenter alignright alignjustify | bullist numlist | forecolor backcolor | link unlink  media image | removeformat preview fullscreen codesample code',
