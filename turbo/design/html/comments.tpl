                                        ...
                                        <div class="turbo_list_row">
                                            ...
                                            <div class="turbo_list_boding turbo_list_comments_name {if $level > 0}admin_note{/if}">
                                                <div class="turbo_list_text_inline mb-q mr-1 {if !$comment->admin}admin{/if}">
                                                    <span class="text_dark text_bold">{$btr->general_name|escape}: </span> <a href="{url module=CommentAdmin id=$comment->id return=$smarty.server.REQUEST_URI}">{$comment->name|escape}</a>
                                                </div>
                                                {if $comment->email}
                                                ...
                                                <a class="comment_object" href="index.php?module=CommentsAdmin&item_id={$comment->object_id}&type={$comment->type}">{$btr->all_comments_to_object|escape}</a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal " method="post">
                    ...
                    <button type="submit" name="comment_answer" value="1" class="btn btn_small btn_green mx-h">
                        {include file='svg_icon.tpl' svgId='checked'}
