                        ...
                        <div class="col-lg-4 col-md-6 col-sm-12">
						 ...
						 <div class="col-lg-4 col-md-6 col-sm-12">
                            <div class="banner_card">
                                ...
                                <div class="banner_card_block">
                                    <select name="articles_categories[]" class="selectpicker" multiple="multiple" data-selected-text-format="count">
                                        <option value='0' {if !$banner->articles_category_selected || 0|in_array:$banner->articles_category_selected}selected{/if}>Не отображать</option>
