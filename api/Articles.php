...
class Articles extends Turbo
{
	...
	/*
	*
	* Функция возвращает статью по её id или url
	* (в зависимости от типа аргумента, int - id, string - url)
	* @param $id id или url статьи
	*
	*/
	...
	/*
	*
	* Функция возвращает массив статей, удовлетворяющих фильтру
	* @param $filter
	*
	*/
	...
	/*
	*
	* Функция вычисляет количество статей, удовлетворяющих фильтру
	* @param $filter
	*
	*/
	...
	*/	
	...
	{	
		...
		// Если есть статья с таким URL, добавляем к ней число
	...
	*/	
	...
	/**
    * Функция вносит +1 к просмотру статьи
    * @param $id
    * @retval object
    */
