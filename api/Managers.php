...
{	
	public $permissions_list = array('callbacks', 'users', 'pages', 'menus', 'blog', 'comments', 'feedbacks', 'clear', 'articles', 'projects',
		'backup', 'subscribes', 'design', 'banners', 'settings', 'seo', 'managers', 'languages', 'license');
